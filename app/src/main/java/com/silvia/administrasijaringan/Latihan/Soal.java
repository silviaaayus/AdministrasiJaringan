...
public class Soal extends AppCompatActivity {
    ...
    public void setKonten(){
        ...
        if(x >= arr){ //jika nilai x melebihi nilai arr(panjang array) maka akan pindah activity (kuis selesai)
            ...
            Intent i = new Intent(Soal.this, Hasil.class);
...
//        String url = api.URL_EVALUASI_DUA_PARAMETER(id,idevaluasi);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject res) {
                try {
                    ...
                    if (status == 200){
                        ...
                        Toast.makeText(Soal.this,  pesan, Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Soal.this, "Gagal Mengambil Data", Toast.LENGTH_SHORT).show();
            }
        });
